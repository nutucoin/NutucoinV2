...
"""Verify that starting nutucoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nutucoin with -h for help text")
        ...
        self.log.info("Start nutucoin with -version for version information")
        ...
        self.log.info("Start nutucoind with -fakearg to make sure it does not start")
