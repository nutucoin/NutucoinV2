...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    """Base class for a nutucoin test script.

    Individual nutucoin test scripts should subclass this class and override the set_test_params() and run_test() methods.
    ...
    def main(self):
        ...
        parser.add_argument("--nocleanup", dest="nocleanup", default=False, action="store_true",
                            help="Leave nutucoinds and test.* datadir on exit or error")
        parser.add_argument("--noshutdown", dest="noshutdown", default=False, action="store_true",
                            help="Don't stop nutucoinds after the test execution")
        ...
        parser.add_argument("--usecli", dest="usecli", default=False, action="store_true",
                            help="use nutucoin-cli instead of RPC for all commands")
        ...
        if not self.options.noshutdown:
            ...
            self.log.info("Note: nutucoinds were not stopped and may still be running")
    ...
    def stop_node(self, i, expected_stderr=''):
        """Stop a nutucoind test node"""
        self.nodes[i].stop_node(expected_stderr)
        self.nodes[i].wait_until_stopped()

    def stop_nodes(self):
        """Stop multiple nutucoind test nodes"""
        for node in self.nodes:
