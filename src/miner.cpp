...
std::unique_ptr<CBlockTemplate> BlockAssembler::CreateNewBlock(const CScript& scriptPubKeyIn, bool fMineWitnessTx, bool fCheckTimer)
{
    ...
    if (!TestBlockValidity(state, chainparams, *pblock, pindexPrev, false, false, fCheckTimer)) {
