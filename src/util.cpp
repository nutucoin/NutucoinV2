...
const char * const BITCOIN_CONF_FILENAME = "nutucoin.conf";
const char * const BITCOIN_PID_FILENAME = "nutucoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nutucoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Nutucoin";
#else
    // Unix
    return pathRet / ".nutucoin";
#endif
#endif
}
