...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nutucoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nutucoin-tx [options] <hex-tx> [commands]  Update hex-encoded nutucoin transaction\n" +
            "or:     nutucoin-tx [options] -create [commands]   Create hex-encoded nutucoin transaction\n" +
            "\n";
