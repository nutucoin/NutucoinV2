...
* nutucoin.conf: contains configuration settings for nutucoind or nutucoin-qt
* nutucoind.pid: stores the process id of nutucoind while running
...
* debug.log: contains debug information and general logging generated by nutucoind or nutucoin-qt
