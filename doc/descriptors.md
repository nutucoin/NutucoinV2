# Support for Output Descriptors in Nutucoin Core

Since Nutucoin Core v0.17, there is support for Output Descriptors in the
...
on Nutucoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Nutucoin Core wallets, a convenience function `combo` is
